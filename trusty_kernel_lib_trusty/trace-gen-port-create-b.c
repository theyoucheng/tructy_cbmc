...
int main(void) {
    ...
    //// cbmc non_det variables
    int cbmc_buf_num, cbmc_buf_size; 

    __CPROVER_assume(cbmc_buf_num>=0);
    __CPROVER_assume(cbmc_buf_size>=0);

    rc = sys_port_create(TEST_CTRL_PORT, cbmc_buf_num, cbmc_buf_size, IPC_PORT_ALLOW_NS_CONNECT);
    
    //__CPROVER_assert(0, "================================= trace gen trap condition  ================================================================");
